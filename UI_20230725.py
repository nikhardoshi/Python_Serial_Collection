...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.display_title(master_=self.sidebar_frame_lower, size_ = 16, text_ = "Select the State of pump please!", row_= 8, column_= 0, padx_= (sc_width * 2)//70, pady_= (20, 0))
        ...
        self.combobox_var4 = customtkinter.StringVar(value="Select")
        ...
        self.combobox4 = customtkinter.CTkComboBox(self.sidebar_frame_lower, state = 'readonly', values= pump_state, font=('Arial', 14), command = self.combobox_callback, variable=self.combobox_var4, corner_radius = 2, justify='left',  height=32)
        self.combobox4.grid(row = 9, column= 0, padx = ((sc_width * 1.5)//250, 0), pady=(0, 15))
        ...
        self.Set_DOE.grid(row = 10, column = 0, padx = ((sc_width * 1.5)//200, 0), pady=(15, 20))
    ...
    def serial_port(self):
        ...
        experiment_name = str(self.combobox_var1.get()) + '_' + str(self.combobox_var2.get()) + '_' + str(self.combobox_var3.get()) + '_' + str(self.combobox_var4.get()) + '_'
    ...
    def Set_DOE_button(self):
        ...
        self.combobox4.configure(state='disabled')
